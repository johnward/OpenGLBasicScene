...
vec4 CalcPointLights()
{
    ...
    {
        vec3 direction = FragPos - pointLights[i].position; // direction from the light to the fragment
        float distance = length(direction); // x in quadratic equation for drop off
